...
export const LayoutGrid = ({ cards }: { cards: Card[] }) => {
  ...
  const handleClick = (card: Card) => {
    ...
    // Scroll the whole grid container into the center of the viewport
    // so the expanded card (which centers itself inside this container)
    // is always visible, no matter which card was clicked.
