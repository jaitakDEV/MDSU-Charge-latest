...
// //   [ROUTES.facultyProfile]: "Profile",
// //   [ROUTES.facultySettings]: "Settings",
// // };

// // export function FacultyTopbar({ user }: { user: FacultyUser }) {
// //   const pathname = usePathname();
// //   const title = pageTitles[pathname] ?? "Faculty";
...
//   const firstLetter = (user?.name ?? "F")[0].toUpperCase();
...
//           <div
//             style={{ width: "1px", height: "18px", background: "#e2e8f0" }}
//           />
...
export function FacultyTopbar({ user }: { user: FacultyUser }) {
  ...
  return (
    <>
      ...
      >
        {/* LEFT: Logo + Divider + Page Title + Badge */}
