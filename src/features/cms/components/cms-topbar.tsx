...
// type CmsUser = { name: string | null; email: string };

// const pageTitles: Record<string, string> = {
//   [ROUTES.cms]: "Overview",
//   [ROUTES.cmsProfile]: "Profile",
//   [ROUTES.cmsSettings]: "Settings",
// };

// export function CmsTopbar({ user }: { user: CmsUser }) {
//   const pathname = usePathname();
//   const title = pageTitles[pathname] ?? "CMS";
//   const [showModal, setShowModal] = useState(false);

//   const firstLetter = (user?.name ?? "C")[0].toUpperCase();
//   const firstName = user?.name?.split(" ")[0] ?? "Editor";
